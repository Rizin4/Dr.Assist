...
INSTALLED_APPS = [
    ...
    # Third Party
    # pip install import_export crispy_forms django-mathfilters django-ckeditor5 django-taggit djangorestframework django-cors-headers django-ckeditor-uploader django-rest-framework-simplejwt
    'import_export',
    'crispy_forms',
    'mathfilters',
